            ...
            <form action="" method="POST" id="FormAgregar">
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="d_costo">Costo unitario</label>
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="d_existencia">Existencia</label>
                            <input type="text" class="form-control" id="d_existencia" name="d_existencia" disabled>
                        </div>
                    </div>
                </div>
            </form>
